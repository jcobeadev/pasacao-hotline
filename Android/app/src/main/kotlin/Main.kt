...
internal val logger: SkipLogger = SkipLogger(subsystem = "pasacao.hotline", category = "PasacaoHotline")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        PasacaoHotlineAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        PasacaoHotlineAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        PasacaoHotlineAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        PasacaoHotlineAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        PasacaoHotlineAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        PasacaoHotlineAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            PasacaoHotlineRootView().Compose(context = contentContext)
        }
    }
}
